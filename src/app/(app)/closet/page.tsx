...
import EssentialsModal from "@/components/closet/EssentialsModal";
      ...
      <div className="flex items-center justify-between px-5 pt-14 pb-4 bg-[#FBF9F6] border-b border-[#EDE8E1]">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="text-[10px] font-black tracking-[0.18em] uppercase text-[#111111] border border-[#D4CCC4] px-3 py-2"
          >
            + Add Basics
          </button>
          <button
